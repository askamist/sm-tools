    ...
    <b-tabs>
      <b-tab-item label="From geoStrings">
        <b-field label="Enter a list GeoHash-s seperated by space">
          <b-input v-model="geoHashString" maxlength="7000" type="textarea"></b-input>
        </b-field>
        <button class="button" v-on:click="generateKMLfromHashList">Download kml files as zip</button>
      </b-tab-item>
